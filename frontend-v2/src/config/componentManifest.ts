...
export const componentManifest = defineComponentManifest({
  ...
  AgentChatContent: { parent: "Base", source: "components/AgentChatContent/AgentChatContent.tsx", labGroup: "browser" },
  ...
  AgentChatBrowser: { parent: "TreeBrowser", source: "components/AgentChatBrowser/AgentChatBrowser.tsx", labGroup: "browser" },
